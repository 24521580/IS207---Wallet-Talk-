...
<head>
    ...
    <title>Ví Nói — Bạn nói, Ví Nói ghi.</title>
    <meta name="description" content="Nhập một câu tiếng Việt tự nhiên, Ví Nói tách thành nhiều khoản thu/chi có cấu trúc để bạn kiểm tra và lưu.">
...
<body class="antialiased">
    <header class="border-b border-line/80 bg-cream/90">
        <div class="page-shell flex items-center justify-between gap-3 py-3">
            <span class="flex min-h-0 items-center gap-2 font-semibold">
                ...
                <span>
                    Ví Nói
                    <span class="block text-xs font-normal text-ink-soft">Bạn nói, Ví Nói ghi.</span>
                </span>
            </span>
    ...
    <main class="page-shell py-10 lg:py-14">
        <section class="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
                <p class="chip">Personal finance · Ngôn ngữ tự nhiên</p>
                ...
                <p class="mt-4 max-w-xl text-ink-soft">
                    Nhập những gì bạn đã chi bằng một câu tiếng Việt. Ví Nói tự động tách thành nhiều giao dịch,
                    phân loại danh mục, rồi để bạn kiểm tra trước khi lưu.
                </p>
                ...
                <p class="mt-4 text-sm text-ink-soft">
                    Tài khoản demo: <strong>demo@vinoi.com</strong> / <strong>Demo123@</strong>
                </p>
            </div>
            ...
            <div class="card p-5">
                ...
                <p class="mt-4 text-sm font-medium text-ink-soft">Ví Nói tách thành</p>
                <div class="mt-2 grid gap-2">
                    @foreach ([
                        ['Ăn sáng', 'Ăn uống', '30.000 ₫'],
                        ['Đổ xăng', 'Di chuyển', '100.000 ₫'],
                        ['Mua sách', 'Giáo dục', '150.000 ₫'],
                ...
                <p class="mt-3 text-sm text-ink-soft">AI đề xuất – Vui lòng kiểm tra trước khi lưu.</p>
            </div>
        </section>

        <section class="mt-12 grid gap-4 sm:grid-cols-3">
            @foreach ([
                ['1. Nhập bằng ngôn ngữ tự nhiên', 'Một câu, nhiều khoản. Không cần chọn danh mục hay nhập ngày tháng.'],
                ['2. AI tách thành giao dịch', '“30k” thành 30.000 , “hôm qua” thành đúng ngày, mỗi khoản một danh mục.'],
                ['3. Bạn kiểm tra rồi mới lưu', 'Sửa, xóa hoặc thêm khoản thủ công. Ví Nói chỉ lưu khi bạn xác nhận.'],
        ...
        <section class="mt-10 card p-5">
            <h2 class="font-semibold">Ví Nói không phải là chatbot</h2>
            <p class="mt-2 max-w-3xl text-sm text-ink-soft">
                AI ở đây chỉ làm một việc: đọc câu tiếng Việt và trả về JSON có cấu trúc.
                Kết quả AI không bao giờ được ghi thẳng vào cơ sở dữ liệu — luôn có bước người dùng kiểm tra và xác nhận.
            </p>
        </section>
    </main>
