...
<head>
    ...
    <title>@yield('title', 'Ví Nói') — Bạn nói, Ví Nói ghi.</title>
            ...
            <div class="page-shell flex items-center justify-between gap-3 py-3">
                ...
                <nav class="hidden items-center gap-1 lg:flex">
                    ...
                    @if (config('ai.demo_mode'))
                        <span class="chip border-clay/40 text-clay" title="Kết quả AI đến từ bộ phân tích mẫu, không phải API thật">
                            Demo AI Mode
                        </span>
                    @endif
